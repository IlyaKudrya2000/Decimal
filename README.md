...
1. [Двоичное представление](#двоичное-представление)
2. [Арифметические операторы](#арифметические-операторы)
3. [Операторы сравнение](#операторы-сравнение)
4. [Операторы сравнение](#преобразователи)
5. [Другие функции](#другие-функции) 
6. [Реализация функции библиотеки decimal.h](#реализация-функции-библиотеки-decimal.h)
